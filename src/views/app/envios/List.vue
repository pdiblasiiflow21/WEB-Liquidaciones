<template>
    <div class="envios-container" v-if="canSeePage()">
        ...
        <template slot="filters"> 
                ...
                <div class="filter-sm">
                    <select-deluxe resource="clientes" class="list-filter" :filter="filterClient" :selectItemLabel="({ razonSocial }) => `${razonSocial}`"  method="getAll"  valueField="id" placeholder="Buscar por Razón Social / Usuario OMS" v-model="filtroGrillaOptions.clienteId" ></select-deluxe>
                </div>          
            </b-colxx>      
            ...
            <template slot='columns'>
                ...
                <column :field="(entity) => entity.cliente.razonSocial"  title="Razon Social" width="40" />                                         
